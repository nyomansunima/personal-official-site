  ...
  return (
    <main className="flex flex-col laptop:py-20 py-20">
      <div className="container mx-auto">
        <article className="text-foreground mx-auto px-5 prose prose-lg dark:prose-invert prose-headings:font-medium dark:prose-headings:text-foreground laptop:prose-h1:text-6xl prose-h1:text-5xl prose-a:no-underline">
          <h1 data-cursor-size="200" data-cursor-exclusion>
            Privacy Policy
          </h1>
          <p>
            <strong>Effective Date: Monday, 12 June 2023</strong>
          </p>

          <p>
            This Privacy Policy outlines the information practices and
            procedures followed by https://nyomansunima.com ("we," "us," or
            "our") regarding the collection, use, and disclosure of personal
            information when you access and use our website (the "Website"). We
            are committed to protecting your privacy and ensuring the security
            of your personal information. By accessing or using our Website, you
