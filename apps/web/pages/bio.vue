<template>
  <dv>
    ...
    <Head>
      <Title>Bio</Title>
      <Meta name="description" content="Explore the bio and links" />
    </Head>

    <!-- content -->
    <main
      class="flex container mx-auto py-16 px-5 tablet:px-0 tablet:py-32 justify-center"
    >
      <div class="flex flex-col tablet:w-6/12">
        ...
        <div class="flex flex-col w-full items-center">
          <div
            class="flex h-28 w-28 rounded-full relative overflow-hidden before:content-[''] before:absolute p-3 before:inset-0 before:border-2 before:border-gray-200 dark:border-gray-800 before:rounded-full"
          >
            <NuxtImg
              :src="content.avatar"
